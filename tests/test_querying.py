...
from graphrecords import EdgeIndex, GraphRecord, NodeIndex
...
def simple_example_dataset() -> GraphRecord:
    ...
    graphrecord.add_edges(
        (patient_diagnosis_edges, "patient_id", "diagnosis_code"), "patient_diagnosis"
    )
    graphrecord.add_edges(
        (patient_drug_edges, "patient_id", "drug_code"), "patient_drug"
    )
    graphrecord.add_edges(
        (patient_procedure_edges, "patient_id", "procedure_code"), "patient_procedure"
    )
...
class TestPythonTypesConversion(unittest.TestCase):
    def test_node_python_types_conversion(self) -> None:
        ...
        graphrecord.query_nodes(query1)
        ...
        assert isinstance(type1, GraphRecordValue)
        ...
        graphrecord.query_nodes(query2)
        ...
        assert all(isinstance(item, GraphRecordValue) for item in type3)
        ...
        graphrecord.query_nodes(query3)
        ...
        graphrecord.query_nodes(query4)
        ...
        graphrecord.query_nodes(query5)
    ...
    def test_edge_python_types_conversion(self) -> None:
        ...
        graphrecord.query_edges(query1)
        ...
        graphrecord.query_edges(query2)
        ...
        graphrecord.query_edges(query3)
        ...
        graphrecord.query_edges(query4)
        ...
        graphrecord.query_edges(query5)
        ...
        graphrecord.query_edges(query6)
        ...
        graphrecord.query_edges(query7)
...
class TestNodeOperand(unittest.TestCase):
    ...
    def test_node_operand_index(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == ["pat_1"]
    ...
    def test_node_operand_in_group(self) -> None:
        ...
        assert sorted(self.graphrecord.query_nodes(query1)) == [
            "pat_1",
            "pat_2",
            "pat_3",
            "pat_4",
        ...
        self.graphrecord.add_nodes_to_group("diagnosis", "pat_1")

        assert sorted(self.graphrecord.query_nodes(query2)) == ["pat_1"]

        self.graphrecord.add_group("test_group", "diagnosis_10509002")

        def query3(node: NodeOperand) -> NodeIndicesOperand:
            node.in_group((["patient", "test_group"], MatchMode.ANY))  # Must be in ANY
            return node.index()

        assert sorted(self.graphrecord.query_nodes(query3)) == [
            "diagnosis_10509002",
            "pat_1",
            "pat_2",
            "pat_3",
    ...
    def test_node_operand_has_attribute(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query1) == ["pat_1"]
        ...
        assert self.graphrecord.query_nodes(query2) == ["pat_1"]
        ...
        assert self.graphrecord.query_nodes(query3) == ["pat_1"]
    ...
    def test_node_operand_edges(self) -> None:
        ...
        assert 0 in self.graphrecord.query_nodes(query1)

        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_edges(("pat_2", "pat_1", {}))

        def query2(node: NodeOperand) -> EdgeIndicesOperand:
            query_node(node)
            return node.edges(EdgeDirection.INCOMING).index()

        assert self.graphrecord.query_nodes(query2) == [160]

        def query3(node: NodeOperand) -> EdgeIndicesOperand:
            query_node(node)
            return node.edges(EdgeDirection.BOTH).index()

        assert 0 in self.graphrecord.query_nodes(query3)
        assert 160 in self.graphrecord.query_nodes(query3)
    ...
    def test_node_operand_neighbors(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query1) == ["pat_2"]
        ...
        assert "procedure_171207006" in self.graphrecord.query_nodes(query2)
        ...
        assert "pat_2" in self.graphrecord.query_nodes(query3)
        assert "procedure_171207006" in self.graphrecord.query_nodes(query3)
    ...
    def test_node_operand_either_or(self) -> None:
        ...
        assert sorted(self.graphrecord.query_nodes(query)) == ["pat_3", "pat_4"]
    ...
    def test_node_operand_exclude(self) -> None:
        ...
        assert sorted(self.graphrecord.query_nodes(query)) == ["pat_2", "pat_4"]
...
class TestNodeGroupOperand(unittest.TestCase):
    ...
    def test_group_operand_attribute(self) -> None:
        ...
        result = sorted(
            (sort_tuple(item) for item in self.graphrecord.query_nodes(query)),
    ...
    def test_group_operand_in_group(self) -> None:
        ...
        result2 = sorted(
            (sort_tuple(item) for item in self.graphrecord.query_nodes(query2)),
            key=operator.itemgetter(0),
        )
        assert result2 == [
            ("M", ["pat_1"]),
    ...
    def test_group_operand_edges(self) -> None:
        ...
        result = sorted(self.graphrecord.query_nodes(query), key=operator.itemgetter(0))
        assert result == [("F", []), ("M", [0])]
...
class TestEdgeOperand(unittest.TestCase):
    ...
    def test_edge_operand_attribute_simple(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == {0: datetime(2014, 2, 6, 0, 0)}
    ...
    def test_edge_operand_attributes(self) -> None:
        ...
        result = {
            key: sorted(value)
            for key, value in self.graphrecord.query_edges(query).items()
        }
    ...
    def test_edge_operand_index(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [0]
    ...
    def test_edge_operand_in_group(self) -> None:
        ...
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_group("treatment")
        self.graphrecord.add_edges_to_group("treatment", 0)

        assert self.graphrecord.query_edges(query2) == [0]

        self.graphrecord.add_group("test_group", None, 1)
        ...
        assert sorted(self.graphrecord.query_edges(query3)) == [0, 1]
    ...
    def test_edge_operand_source_node(self) -> None:
        ...
        result = self.graphrecord.query_edges(query)
        assert result == ["pat_1"]
    ...
    def test_edge_operand_either_or(self) -> None:
        ...
        assert sorted(self.graphrecord.query_edges(query)) == [0, 1]
    ...
    def test_edge_operand_exclude(self) -> None:
        ...
        assert sorted(self.graphrecord.query_edges(query)) == [0, 4]
    ...
    def test_edge_operand_clone(self) -> None:
        ...
        assert sorted(self.graphrecord.query_edges(query)) == [0, 1, 2, 3, 4]
...
class TestEdgeGroupOperand(unittest.TestCase):
    ...
    def test_edge_group_operand_attribute(self) -> None:
        ...
        assert sorted(self.graphrecord.query_edges(query)) == [
    ...
    def test_edge_group_operand_attributes(self) -> None:
        ...
        result = sorted(
            (sort_tuple(item) for item in self.graphrecord.query_edges(query)),
            key=operator.itemgetter(0),
        )
        assert result == [
            (
    ...
    def test_edge_group_operand_in_group(self) -> None:
        ...
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_group("temp_group", None, 0)
        ...
        result2 = sorted(
            (sort_tuple(item) for item in self.graphrecord.query_edges(query2)),
            key=operator.itemgetter(0),
        )
        assert result2 == [
            ("pat_1", [0]),
...
class TestNodeMultipleValuesWithIndexGroupOperand(unittest.TestCase):
    ...
    def test_is_string(self) -> None:
        ...
        result = sorted(
            (self.sort_tuple(item) for item in self.graphrecord.query_nodes(query)),
            key=operator.itemgetter(0),
        )
        assert result == [
            ("F", {"pat_2": "F", "pat_3": "F"}),
    ...
    def test_is_float(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"float_attribute": 2.3, "gender": "M"}))
    ...
    def test_is_bool(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"bool_attribute": True, "gender": "M"}))
    ...
    def test_is_null(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"null_attribute": None, "gender": "M"}))
    ...
    def test_round_ceil_floor(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(
            ("pat_6", {"float_attribute": 2.34567, "gender": "M"})
        )
    ...
    def test_absolute(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"float_attribute": -2.35, "gender": "M"}))
    ...
    def test_sqrt(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"number": 81, "gender": "M"}))
...
class TestNodeMultipleValuesWithoutIndexOperand(unittest.TestCase):
    ...
    def test_max(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == 59
    ...
    def test_min(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(32.66, rel=1e-2)
    ...
    def test_mean(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(45.833, rel=1e-2)
    ...
    def test_mode(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) in [22, 19]
    ...
    def test_std(self) -> None:
        ...
        std = self.graphrecord.query_nodes(query)
    ...
    def test_var(self) -> None:
        ...
        var = self.graphrecord.query_nodes(query)
    ...
    def test_sum(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(91.66, rel=1e-2)
    ...
    def test_is_string(self) -> None:
        ...
        assert sorted(
            self.graphrecord.query_nodes(query), key=lambda x: (x is None, x)
        ) == ["F", "M"]

    def test_is_int(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"gender": "F", "int_attribute": 5}))
        self.graphrecord.add_nodes(("pat_7", {"gender": "M", "int_attribute": 10}))
    ...
    def test_is_bool(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"gender": "F", "bool_attribute": True}))
        self.graphrecord.add_nodes(("pat_7", {"gender": "M", "bool_attribute": False}))
    ...
    def test_is_null(self) -> None:
        self.graphrecord.unfreeze_schema()
        self.graphrecord.add_nodes(("pat_6", {"gender": "F", "null_attribute": None}))
        self.graphrecord.add_nodes(("pat_7", {"gender": "M", "null_attribute": None}))
    ...
    def test_add(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [60]
    ...
    def test_subtract(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [58]
    ...
    def test_multiply(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [118]
    ...
    def test_divide(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [29.5]
    ...
    def test_power(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [3481]
    ...
    def test_round(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [30]
    ...
    def test_floor(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [29]
    ...
    def test_sqrt(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == [pytest.approx(7.69, rel=1e-2)]
    ...
    def test_string_operations(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == ["Hello World"]
        ...
        assert self.graphrecord.query_nodes(query1) == ["Hello World "]
        ...
        assert self.graphrecord.query_nodes(query2) == [" Hello World"]
        ...
        assert self.graphrecord.query_nodes(query3) == [" hello world "]
        ...
        assert self.graphrecord.query_nodes(query4) == [" HELLO WORLD "]
        ...
        assert self.graphrecord.query_nodes(query5) == [" Hello"]
...
class TestNodeMultipleValuesWithIndexOperand(unittest.TestCase):
    ...
    def test_node_multiple_values_operand_numeric(self) -> None:
        ...
        assert (
            self.graphrecord.query_nodes(lambda node: node.attribute("age").mean())
            == 43.2
        )

        assert (
            self.graphrecord.query_nodes(lambda node: node.attribute("age").median())
            == 37
        )

        graphrecord_mode = self.graphrecord.clone()
        graphrecord_mode.unfreeze_schema()
        graphrecord_mode.add_nodes(("pat_6", {"age": 22}))
        assert (
            graphrecord_mode.query_nodes(lambda node: node.attribute("age").mode())
            == 22
        )
        assert self.graphrecord.query_nodes(
        ...
        assert (
            self.graphrecord.query_nodes(lambda node: node.attribute("age").count())
            == 5
        )
        assert (
            self.graphrecord.query_nodes(lambda node: node.attribute("age").sum())
            == 216
        )
    ...
    def test_node_multiple_values_operand_datatypes(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query4) == ["pat_6"]

        self.graphrecord.add_nodes(("pat_7", {"float_attribute": 2.3}))
        ...
        assert self.graphrecord.query_nodes(query5) == ["pat_7"]

        self.graphrecord.add_nodes(("pat_8", {"duration_attribute": timedelta(days=3)}))
        ...
        assert self.graphrecord.query_nodes(query6) == ["pat_8"]

        self.graphrecord.add_nodes(("pat_9", {"bool_attribute": True}))

        def query7(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("bool_attribute").is_bool()
            return node.index()

        assert self.graphrecord.query_nodes(query7) == ["pat_9"]

        self.graphrecord.add_nodes(("pat_10", {"null_attribute": None}))

        def query8(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("null_attribute").is_null()
            return node.index()

        assert self.graphrecord.query_nodes(query8) == ["pat_10"]
    ...
    def test_node_multiple_values_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query1) == ["pat_3"]

        def query2(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").is_min()
            return node.index()

        assert self.graphrecord.query_nodes(query2) == ["pat_4"]

        def query3(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").greater_than(90)
            return node.index()

        assert self.graphrecord.query_nodes(query3) == ["pat_3"]

        def query4(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").less_than(20)
            return node.index()

        assert self.graphrecord.query_nodes(query4) == ["pat_4"]

        def query5(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").equal_to(42)
            return node.index()

        assert self.graphrecord.query_nodes(query5) == ["pat_1"]

        def query6(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").not_equal_to(42)
            return node.index()

        assert sorted(self.graphrecord.query_nodes(query6)) == [
            "pat_2",
            "pat_3",
            "pat_4",
            "pat_5",
        ...
        assert sorted(self.graphrecord.query_nodes(query7)) == ["pat_1", "pat_4"]

        def query8(node: NodeOperand) -> NodeIndicesOperand:
            node.attribute("age").is_not_in([42, 19])
            return node.index()

        assert sorted(self.graphrecord.query_nodes(query8)) == [
            "pat_2",
            "pat_3",
            "pat_5",
        ]
        ...
        assert sorted(self.graphrecord.query_nodes(query9)) == [
            "pat_1",
            "pat_2",
            "pat_4",
            "pat_5",
...
class TestEdgeMultipleValuesWithIndexOperand(unittest.TestCase):
    ...
    def test_edge_multiple_values_operand_numeric(self) -> None:
        ...
        assert self.graphrecord.query_edges(query_min) == (4, 0)
        ...
        assert self.graphrecord.query_edges(query_max) == (47, 3416)
        ...
        assert self.graphrecord.query_edges(query_mean) == pytest.approx(
            405.07, rel=1e-2
        )
        ...
        assert self.graphrecord.query_edges(query_median) == 315
        ...
        assert self.graphrecord.query_edges(query_mode) == 371
        ...
        assert self.graphrecord.query_edges(query_std) == pytest.approx(
            605.22, rel=1e-2
        )
        ...
        assert self.graphrecord.query_edges(query_var) == pytest.approx(
            366285.42, rel=1e-2
        )
        ...
        assert self.graphrecord.query_edges(query_count) == 43
        ...
        assert self.graphrecord.query_edges(query_sum) == 17416
        ...
        assert self.graphrecord.query_edges(query_random) == (3, 12)
    ...
    def test_edge_multiple_values_operand_datatypes(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == [160]

        def query2(edge: EdgeOperand) -> EdgeIndicesOperand:
            edge.attribute("duration_days").is_string()
            return edge.index()

        assert self.graphrecord.query_edges(query2) == []
    ...
    def test_edge_multiple_values_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == [47]
        ...
        assert sorted(self.graphrecord.query_edges(query2)) == [4, 6]
        ...
        assert sorted(self.graphrecord.query_edges(query3)) == [1, 2]
        ...
        assert self.graphrecord.query_edges(query4) == [4]
        ...
        assert sorted(self.graphrecord.query_edges(query5)) == [4, 6]
        ...
        assert sorted(self.graphrecord.query_edges(query6)) == [0, 1]
        ...
        assert sorted(self.graphrecord.query_edges(query7)) == [3, 4]
        ...
        assert sorted(self.graphrecord.query_edges(query8)) == [0, 1, 2]
        ...
        assert sorted(self.graphrecord.query_edges(query9)) == [3, 4]
    ...
    def test_edge_multiple_values_operand_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == {3: 22}
        ...
        assert self.graphrecord.query_edges(query2) == {3: 11}
        ...
        assert self.graphrecord.query_edges(query3) == {3: 60}
        ...
        assert self.graphrecord.query_edges(query4) == {3: 3}
        ...
        assert self.graphrecord.query_edges(query5) == {3: 0}
        ...
        assert self.graphrecord.query_edges(query6) == {3: 1728}
        ...
        assert self.graphrecord.query_edges(query7) == {3: 2}
        ...
        assert self.graphrecord.query_edges(query8) == {3: 3}
        ...
        assert self.graphrecord.query_edges(query9) == {3: 3}
        ...
        assert self.graphrecord.query_edges(query11) == {3: 3}
        ...
        assert self.graphrecord.query_edges(query12) == {160: " hello "}
        ...
        assert self.graphrecord.query_edges(query13) == {160: " HELLO "}
        ...
        assert self.graphrecord.query_edges(query14) == {160: "Hello"}
        ...
        assert self.graphrecord.query_edges(query15) == {160: "Hello "}
        ...
        assert self.graphrecord.query_edges(query16) == {160: " Hello"}
        ...
        assert self.graphrecord.query_edges(query17) == {160: "He"}
        ...
        assert self.graphrecord.query_edges(query17_time_add) == {
        ...
        assert self.graphrecord.query_edges(query18_time_subtract) == {
        ...
        assert sorted(self.graphrecord.query_edges(query19)) == [3, 4]
        ...
        assert sorted(self.graphrecord.query_edges(query20)) == [0, 1, 2, 3]
        ...
        assert self.graphrecord.query_edges(query21) == {3: 12}
        ...
        assert self.graphrecord.query_edges(query22) == {
            3: pytest.approx(3.46, rel=1e-2)
        }
...
class TestEdgeMultipleValuesWithIndexGroupOperand(unittest.TestCase):
    ...
    def test_min(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_min))
        assert result == [
            ("pat_1", (4, 0.0)),
            ("pat_3", (28, 371.0)),
        ]
    ...
    def test_mean(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_mean))
        assert result == [
            ("pat_1", 6.0),
            ("pat_3", 742.0),
        ]
    ...
    def test_median(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_median))
        assert result == [
            ("pat_1", 6.0),
            ("pat_3", 742.0),
        ]
    ...
    def test_mode(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_mode))
        assert result == [
            ("pat_1", 0.0),
            ("pat_3", 371.0),
        ]
    ...
    def test_sum(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_sum))
        assert result == [
            ("pat_1", 12.0),
            ("pat_3", 1484.0),
        ]
    ...
    def test_count(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_count))
        assert result == [
            ("pat_1", 2),
            ("pat_3", 2),
        ]
    ...
    def test_random(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_random))
        assert result == [
            ("pat_1", (3, 12.0)),
            ("pat_3", (26, 1113.0)),
        ]
    ...
    def test_std(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_std))
        assert result == [
    ...
    def test_var(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_var))
        assert result == [
    ...
    def test_is_string(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_is_string))
        assert result == [
            ("pat_1", {160: " Hello "}),
        ]
    ...
    def test_is_int(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query_is_int))
        assert result == [
            ("pat_1", {160: 5}),
        ]
    ...
    def test_is_max(self) -> None:
        ...
        result = sorted(self.graphrecord.query_edges(query))
        assert result == [
            ("pat_1", {3: 12.0}),
            ("pat_3", {26: 1113.0}),
        ]
    ...
    def test_is_float(self) -> None:
        ...
        result = sorted(
            (self.sort_tuple(item) for item in self.graphrecord.query_edges(query)),
            key=operator.itemgetter(0),
        )
        assert result == [
            ("pat_1", {4: 0.0, 3: 12.0}),
    ...
    def test_greater_than(self) -> None:
        ...
        result = sorted(
            [self.sort_tuple(t) for t in self.graphrecord.query_edges(query)]
        )
    ...
    def test_string_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == [("pat_1", {160: " Hello "})]
        ...
        assert self.graphrecord.query_edges(query2) == [("pat_1", {160: " Hello "})]
        ...
        assert self.graphrecord.query_edges(query3) == [("pat_1", {160: " hello "})]
        ...
        assert self.graphrecord.query_edges(query4) == [("pat_1", {160: " HELLO "})]
        ...
        assert self.graphrecord.query_edges(query5) == [("pat_1", {160: "Hello"})]
        ...
        assert self.graphrecord.query_edges(query6) == [("pat_1", {160: "Hello "})]
        ...
        assert self.graphrecord.query_edges(query7) == [("pat_1", {160: " Hello"})]
        ...
        assert self.graphrecord.query_edges(query8) == [("pat_1", {160: "He"})]
...
class TestEdgeMultipleValuesWithoutIndexOperand(unittest.TestCase):
    ...
    def test_max(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 1007.25
    ...
    def test_min(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 123.4
    ...
    def test_mean(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(404.83)
    ...
    def test_median(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 323.2
    ...
    def test_sum(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(2024.15)
    ...
    def test_count(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 5
    ...
    def test_std(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(318.918, rel=1e-2)
    ...
    def test_var(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(101531, rel=1e-3)
    ...
    def test_is_bool(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [True]
    ...
    def test_is_duration(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [timedelta(hours=2)]
    ...
    def test_is_null(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [None]
    ...
    def test_equal_to(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [408.1]
    ...
    def test_slice(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == ["Hel"]
    ...
    def test_random(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) in [6, 742]
...
class TestNodeSingleValueWithoutIndexOperand(unittest.TestCase):
    ...
    def test_is_int(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == 5
    ...
    def test_is_datetime(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == datetime(2023, 10, 1)
    ...
    def test_is_duration(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == timedelta(hours=2)
    ...
    def test_is_bool(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) is True
    ...
    def test_add(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(55.833, rel=1e-2)
    ...
    def test_subtract(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(35.833, rel=1e-2)
    ...
    def test_multiply(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(91.666, rel=1e-2)
    ...
    def test_divide(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(22.916, rel=1e-2)
    ...
    def test_modulo(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(5.833, rel=1e-2)
    ...
    def test_power(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(2102.6, rel=1e-1)
    ...
    def test_round(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == 46
    ...
    def test_floor(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == 45
    ...
    def test_absolute(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(54.167, rel=1e-2)
    ...
    def test_sqrt(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == pytest.approx(6.77, rel=1e-2)
    ...
    def test_slice(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query) == "Hel"
...
class TestEdgeSingleValueWithIndexOperand(unittest.TestCase):
    ...
    def test_edge_single_value_operand_datatypes(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == (160, " Hello ")
        ...
        assert self.graphrecord.query_edges(query2) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query3) == (0, datetime(2014, 2, 6, 0, 0))
        ...
        assert self.graphrecord.query_edges(query4) == (160, 50.5)
        ...
        assert self.graphrecord.query_edges(query5) == (163, timedelta(hours=2))
        ...
        assert self.graphrecord.query_edges(query6) == (161, True)
        ...
        assert self.graphrecord.query_edges(query7) == (162, None)
        ...
        assert self.graphrecord.query_edges(query8) == (47, 3416)
    ...
    def test_edge_single_value_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query3) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query4) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query5) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query6) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query7) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query8) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query9) == (160, " Hello ")
        ...
        assert self.graphrecord.query_edges(query10) == (160, " Hello ")
        ...
        assert self.graphrecord.query_edges(query11) == (160, " Hello ")
    ...
    def test_edge_single_value_operand_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == (160, 15)
        ...
        assert self.graphrecord.query_edges(query2) == (160, 3)
        ...
        assert self.graphrecord.query_edges(query3) == (160, 15)
        ...
        assert self.graphrecord.query_edges(query4) == (160, 2.5)
        ...
        assert self.graphrecord.query_edges(query5) == (160, 2)
        ...
        assert self.graphrecord.query_edges(query6) == (160, 25)
        ...
        assert self.graphrecord.query_edges(query7) == (160, 50.0)
        ...
        assert self.graphrecord.query_edges(query8) == (160, 51.0)
        ...
        assert self.graphrecord.query_edges(query9) == (160, 51.0)
        ...
        assert self.graphrecord.query_edges(query11) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query17) == (160, "Hel")
        ...
        assert self.graphrecord.query_edges(query18) == (0, datetime(2014, 2, 11))
        ...
        assert self.graphrecord.query_edges(query19) == (0, datetime(2014, 2, 5, 23, 0))
        ...
        assert self.graphrecord.query_edges(query20) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query21) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query22) == (160, 5)
        ...
        assert self.graphrecord.query_edges(query23) == (
            160,
            pytest.approx(2.24, rel=1e-2),
        )
...
class TestEdgeSingleValueWithIndexGroupOperand(unittest.TestCase):
    ...
    def test_ungroup(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == {160: 5}
...
class TestEdgeSingleValueWithoutIndexOperand(unittest.TestCase):
    ...
    def test_is_float(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 50.5
    ...
    def test_is_bool(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) is True
    ...
    def test_greater_than(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(405, rel=1e-2)
    ...
    def test_less_than_or_equal_to(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 371
    ...
    def test_add(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 15
    ...
    def test_subtract(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 3
    ...
    def test_divide(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 2.5
    ...
    def test_power(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 25
    ...
    def test_round(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 51.0
    ...
    def test_floor(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == 50.0
    ...
    def test_sqrt(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == pytest.approx(2.236, rel=1e-2)
...
class TestNodeIndicesOperand(unittest.TestCase):
    ...
    def test_node_indices_operand_comparisons(self) -> None:
        ...
        assert sorted(self.graphrecord.query_nodes(query2)) == [
            "pat_2",
            "pat_3",
            "pat_4",
            "pat_5",
        ...
        assert sorted(self.graphrecord.query_nodes(query4)) == [
            "pat_3",
            "pat_4",
            "pat_5",
        ]
        ...
        assert self.graphrecord.query_nodes(query10) == ["pat_1"]

        def query11(node: NodeOperand) -> NodeIndicesOperand:
            node.index().contains("at")
            return node.index()

        assert sorted(self.graphrecord.query_nodes(query11)) == [
            "pat_1",
            "pat_2",
            "pat_3",
            "pat_4",
...
class TestNodeIndexOperand(unittest.TestCase):
    ...
    def test_node_index_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_nodes(query1) == "pat_5"
        ...
        assert self.graphrecord.query_nodes(query2) == "pat_5"
        ...
        assert self.graphrecord.query_nodes(query3) == "pat_5"
        ...
        assert self.graphrecord.query_nodes(query9) == "pat_5"
        ...
        assert self.graphrecord.query_nodes(query11) == "pat_5"
...
class TestEdgeIndicesOperand(unittest.TestCase):
    ...
    def test_edge_indices_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == [0]
        ...
        assert self.graphrecord.query_edges(query2) == [1]
        ...
        assert self.graphrecord.query_edges(query5) == [0]
        ...
        assert self.graphrecord.query_edges(query7) == [1]
        ...
        assert sorted(self.graphrecord.query_edges(query8)) == [0, 1]

        def query9(edge: EdgeOperand) -> EdgeIndicesOperand:
            edge.index().starts_with(0)
            return edge.index()

        assert self.graphrecord.query_edges(query9) == [0]
        ...
        assert self.graphrecord.query_edges(query10) == [1]
        ...
        assert self.graphrecord.query_edges(query11) == [1]
        ...
        assert self.graphrecord.query_edges(query12) == [1]
        ...
        assert self.graphrecord.query_edges(query13) == [0]
    ...
    def test_edge_indices_operand_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == 11
        ...
        assert self.graphrecord.query_edges(query4) == 21
        ...
        assert self.graphrecord.query_edges(query5) == 11
        ...
        assert sorted(self.graphrecord.query_edges(query6)) == [12, 13]
        ...
        assert sorted(self.graphrecord.query_edges(query7)) == [8, 9]
        ...
        assert sorted(self.graphrecord.query_edges(query8)) == [20, 22]
        ...
        assert sorted(self.graphrecord.query_edges(query9)) == [0, 1]
        ...
        assert sorted(self.graphrecord.query_edges(query10)) == [100, 121]
        ...
        assert sorted(self.graphrecord.query_edges(query11)) == [10, 11]

        def query12(edge: EdgeOperand) -> EdgeIndicesOperand:
            edge.index().exclude(lambda index: index.greater_than(1))
            return edge.index()

        assert sorted(self.graphrecord.query_edges(query12)) == [0, 1]
        ...
        assert sorted(self.graphrecord.query_edges(query13)) == [10, 11]
...
class TestEdgeIndicesGroupOperand(unittest.TestCase):
    ...
    def test_max(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 9)]
    ...
    def test_count(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 10)]
    ...
    def test_sum(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 45)]
    ...
    def test_is_in(self) -> None:
        ...
        result = [(k, sorted(v)) for k, v in self.graphrecord.query_edges(query)]
        assert result == [("pat_1", [0, 1])]
    ...
    def test_equal_to(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", [3])]
    ...
    def test_ungroup(self) -> None:
        ...
        assert sorted(self.graphrecord.query_edges(query)) == list(range(10))
    ...
    def test_contains(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", [5])]
...
class TestEdgeIndexOperand(unittest.TestCase):
    ...
    def test_edge_index_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query3) == 0
        ...
        assert self.graphrecord.query_edges(query6) == 0
        ...
        assert self.graphrecord.query_edges(query8) == 0
        ...
        assert self.graphrecord.query_edges(query10) == 0
        ...
        assert self.graphrecord.query_edges(query11) == 0
    ...
    def test_edge_indices_operand_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == 2
        ...
        # TODO(@JabobKrauskopf, #386): underflow on negative edge indices
        assert self.graphrecord.query_edges(query2) == 4294967294
        ...
        assert self.graphrecord.query_edges(query3) == 22
        ...
        assert self.graphrecord.query_edges(query4) == 1
        ...
        assert self.graphrecord.query_edges(query5) == 121
        ...
        assert self.graphrecord.query_edges(query7) == 0
...
class TestEdgeIndexGroupOperand(unittest.TestCase):
    ...
    def test_less_than(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", None)]
    ...
    def test_subtract(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 8)]
    ...
    def test_multiply(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 18)]
    ...
    def test_modulo(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 1)]
    ...
    def test_power(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("pat_1", 81)]
    ...
    def test_ungroup(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [9]
...
class TestEdgeAttributesTreeOperand(unittest.TestCase):
    ...
    def test_edge_attributes_tree_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == {164: "b_attribute"}
        ...
        assert self.graphrecord.query_edges(query3) == {164: 2}
...
class TestEdgeMultipleAttributesWithIndexGroupOperand(unittest.TestCase):
    ...
    def test_string_operations(self) -> None:
        ...
        assert self.graphrecord.query_edges(query1) == [("value5", {162: "Hello "})]
        ...
        assert self.graphrecord.query_edges(query2) == [("value5", {162: " Hello"})]
        ...
        assert self.graphrecord.query_edges(query3) == [("value5", {162: " He"})]
        ...
        assert self.graphrecord.query_edges(query4) == [("value5", {162: " hello "})]
        ...
        assert self.graphrecord.query_edges(query5) == [("value5", {162: " HELLO "})]
    ...
    def test_to_values(self) -> None:
        ...
        result = sorted(
            (self.sort_values(item) for item in self.graphrecord.query_edges(query)),
            key=operator.itemgetter(0),
        )
...
class TestEdgeSingleAttributeWithIndexOperand(unittest.TestCase):
    ...
    def test_single_attribute_operand_comparisons(self) -> None:
        ...
        assert self.graphrecord.query_edges(query11) == (0, "time")
        ...
        assert self.graphrecord.query_edges(query12) == (0, "time")
        ...
        assert self.graphrecord.query_edges(query13) == (0, "time")
        ...
        assert self.graphrecord.query_edges(query15) == (162, "Hello ")
        ...
        assert self.graphrecord.query_edges(query16) == (162, " Hello")
        ...
        assert self.graphrecord.query_edges(query17) == (162, " He")
        ...
        assert self.graphrecord.query_edges(query18) == (162, " hello ")
        ...
        assert self.graphrecord.query_edges(query19) == (162, " HELLO ")
...
class TestEdgeSingleAttributeWithIndexGroupOperand(unittest.TestCase):
    ...
    def test_slice(self) -> None:
        ...
        assert self.graphrecord.query_edges(query) == [("value5", (162, " He"))]

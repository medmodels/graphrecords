...
GroupKey: TypeAlias = Union[
    NodeIndex, GraphRecordValue, Tuple["GroupKey", "GroupKey"], None
]
...
EdgeAttributesTreeQueryResult: TypeAlias = Dict[EdgeIndex, List[GraphRecordAttribute]]
...
NodeMultipleAttributesWithoutIndexQueryResult: TypeAlias = List[GraphRecordAttribute]
...
NodeSingleAttributeWithoutIndexQueryResult: TypeAlias = GraphRecordAttribute
...
EdgeSingleAttributeWithoutIndexQueryResult: TypeAlias = GraphRecordAttribute
...
NodeMultipleValuesWithoutIndexQueryResult: TypeAlias = List[GraphRecordValue]
EdgeMultipleValuesWithIndexQueryResult: TypeAlias = Dict[EdgeIndex, GraphRecordValue]
...
class NodeOperand:
    ...
    def attribute(
        self, attribute: GraphRecordAttribute
    ) -> NodeMultipleValuesWithIndexOperand:
    ...
    def has_attribute(
        ...
        attribute: Union[
            GraphRecordAttribute,
            List[GraphRecordAttribute],
            Tuple[List[GraphRecordAttribute], MatchMode],
        ],
    ) -> None:

...
class PyNodeAttributesTreeOperand:
    ...
    def count(self) -> PyNodeMultipleValuesWithIndexOperand: ...
...
class PyNodeAttributesTreeGroupOperand:
    ...
    def count(self) -> PyNodeMultipleValuesWithIndexGroupOperand: ...
...
class PyEdgeAttributesTreeOperand:
    ...
    def count(self) -> PyEdgeMultipleValuesWithIndexOperand: ...
...
class PyEdgeAttributesTreeGroupOperand:
    ...
    def count(self) -> PyEdgeMultipleValuesWithIndexGroupOperand: ...

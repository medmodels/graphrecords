...
class PyGraphRecord:
    ...
    @staticmethod
    def with_plugins(plugins: List[PyPlugin]) -> PyGraphRecord: ...
    @staticmethod
    def from_tuples(
...
class PyNodeOperand:
    ...
    def in_group(
        self, group: Union[Group, List[Group], Tuple[List[Group], PyMatchMode]]
    ) -> None: ...
    def has_attribute(
        self,
        attribute: Union[
            ...
            Tuple[List[GraphRecordAttribute], PyMatchMode],
        ],
    ) -> None: ...

...
impl<I: IndexDomain, V: ValueString> ElementKernel<Indexed<I, V>> for LowercaseOperation {
...
impl<V: ValueString + BareValueDomain> ElementKernel<Bare<V>> for LowercaseOperation {
    type Emission = Preserving;
...
impl<E: Build<LowercaseOperation>> Lowercase for E {
    type Output = E::Output;

    fn lowercase(&self) -> Self::Output {
        self.build(LowercaseOperation)
    }
}

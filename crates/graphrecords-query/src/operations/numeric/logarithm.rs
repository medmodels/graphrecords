...
where
    I: IndexDomain,
    for<'a> V: ValueLogarithm + ValueType<Value<'a> = <V as ValueType>::Owned>,
{
    ...
    fn pipeline<'a>(
        ...
        Ok(numeric_indexed::<I, V>(Self::LABEL, V::logarithm))
    }
    ...
    for<'a> V: ValueLogarithm + ValueType<Value<'a> = <V as ValueType>::Owned>,
{
    ...
    fn pipeline<'a>(
        ...
        Ok(numeric_bare::<V>(Self::LABEL, V::logarithm))
    }

...
impl<I, A> ElementKernel<Indexed<I, Scalar>> for GreaterThanOperation<A>
where
    I: IndexDomain,
...
impl<A> ElementKernel<Bare<Scalar>> for GreaterThanOperation<A>
where
...
impl<I, A> ElementKernel<Indexed<I, Mask>> for GreaterThanOperation<A>
where
    I: IndexDomain,
    for<'a> A: ArgumentSource<Keyed<I>, Value<'a> = bool>,
{
    ...
    fn estimate(&self, input: Estimate, stats: &Stats) -> Estimate {
        let selectivity = input
            ...
            .map(|(subject, argument)| subject * (1.0 - argument));
...
impl<A> ElementKernel<Bare<Mask>> for GreaterThanOperation<A>
where
...
impl<I, A> ElementKernel<Indexed<I, AttributeName>> for GreaterThanOperation<A>
where
    I: IndexDomain,
...
impl<A> ElementKernel<Bare<AttributeName>> for GreaterThanOperation<A>
where
...
impl<K, I, A> ElementKernel<Indexed<K, IndexValue<I>>> for GreaterThanOperation<A>
where
    K: IndexDomain,
    I: IndexDomain,
    I::Owned: PartialOrd,
...
impl<I, A> ElementKernel<Bare<IndexValue<I>>> for GreaterThanOperation<A>
where
    I: IndexDomain,
    I::Owned: PartialOrd,
...
impl<I, A> ElementKernel<Indexed<I, FailureKindValue>> for GreaterThanOperation<A>
where
    I: IndexDomain,
...
impl<A> ElementKernel<Bare<FailureKindValue>> for GreaterThanOperation<A>
where

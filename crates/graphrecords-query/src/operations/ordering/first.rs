...
impl<I: IndexDomain> EstimateCost<FirstOperation>
...
impl<I: IndexDomain, E: IndexDomain> EstimateCost<FirstOperation>
...
impl EstimateCost<FirstOperation> for OperandHandle<Bare<Scalar>, Multiple<Ordered>> {

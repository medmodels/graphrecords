...
use crate::{
    ...
    graphrecord::querying::{
        CountableOperand, DeepClone, EvaluateBackward, EvaluateForward, EvaluateForwardGrouped,
        GroupedIterator,
        edges::EdgeOperand,
    ...
    fn evaluate_forward(
        ...
        match &self.context {
            NodeOperandContext::Discriminator(discriminator) => {
                let partitions = NodeOperand::partition(graphrecord, indices, discriminator);
...
impl CountableOperand for NodeIndicesOperand {

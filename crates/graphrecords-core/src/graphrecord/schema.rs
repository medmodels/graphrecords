...
use crate::{
    errors::GraphError,
    graphrecord::{datatypes::DataType, GraphRecordAttribute},
};
...
impl AttributeSchema {
    pub fn new(mapping: HashMap<GraphRecordAttribute, AttributeDataType>) -> Self {
        Self(mapping)
    }
...
impl Schema {
    ...
    pub fn infer(graphrecord: &GraphRecord) -> Self {
        ...
        for edge_index in graphrecord.edge_indices() {
